...
[![keybase identity]({static}/images/2017/10/keybase_identity.png){ width=100% }]({static}/images/2017/10/keybase_identity.png)
...
[![keybase chris folder]({static}/images/2017/10/keybase_chris_folder.png){ width=60% }]({static}/images/2017/10/keybase_chris_folder.png)
...
[![kybase chat]({static}/images/2017/10/keybase_chat.png){ width=100% }]({static}/images/2017/10/keybase_chat.png)
...
[![teams announcement]({static}/images/2017/10/teams-splash-announcement.png){ width=100% }]({static}/images/2017/10/teams-splash-announcement.png)
...
[![keybase git]({static}/images/2017/10/keybase_git.png){ width=100% }]({static}/images/2017/10/keybase_git.png)
